...
public class DBConnection {
    ...
    private static final String URL = "jdbc:mysql://localhost:3306/slackdb?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC"; // MySQL URL followed by the database name
